"""
Django settings for prodavnicesajt project.
...
SECRET_KEY = '$800jbj=j7eo1g(q=pv%%h%)e^a7-bf3p+6a766e7!d^)(&hms'
...
INSTALLED_APPS = [
    'prodavnice.apps.ProdavniceConfig',
...
ROOT_URLCONF = 'prodavnicesajt.urls'
...
WSGI_APPLICATION = 'prodavnicesajt.wsgi.application'
